...
def test_super_search_film(browser):
    ...
    assert "https://www.kinopoisk.ru/s/" in Main_paige.find_and_chek_url()
...
def test_search_by_top(browser):
    ...
    assert "https://www.kinopoisk.ru/lists/movies/top250/" in Main_paige.find_and_chek_url()
...
def test_write_to_support(browser):
    ...
    assert "https://www.kinopoisk.ru/" in Main_paige.find_and_chek_url()
